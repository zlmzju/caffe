...
NEWPRETRAINED = 'MSRA9000_iter_100000.caffemodel'
finetune_net = caffe.Classifier(NEWMODEL_FILE, NEWPRETRAINED,
                       caffe.TEST)
print('\nparams')
print [(k, v[0].data.shape) for k, v in finetune_net.params.items()]
finetune_net.params['score-fr'][0].data.flat=net.params['score-fr'][0].data.flat
finetune_net.params['score-fr'][1].data.flat=net.params['score-fr'][1].data.flat
finetune_net.params['upsample'][0].data.flat=net.params['upsample'][0].data.flat
finetune_net.params['upsample'][1].data.flat=net.params['upsample'][1].data.flat
