...
/* ROIPoolingLayer - Region of Interest Pooling Layer, with angle
*/
template <typename Dtype>
class ROIPoolingAngleLayer : public Layer<Dtype> {
 public:
  explicit ROIPoolingAngleLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "ROIPoolingAngle"; }
